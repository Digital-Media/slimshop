 ...
 *
 * onlineshop and onlineshopsolution have to be stored in the same directory
 *
 * The classes for which a solution should be created have to be stored in the folder src/Exercises of OnlineShop
 *
 ...
 * that can be found in onlineshopsolution/<path to/filename for part of solution>.inc.php
 *
...
final class Solution extends AbstractNormForm
{
     ...
     *
     * Sends an error message, if folder onlineshopsolution, does not exist.
     *
    ...
    public function __construct(View $defaultView)
    {
        ...
        if (!file_exists(__DIR__ . '/../../../onlineshopsolution')) {
